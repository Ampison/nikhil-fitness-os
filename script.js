...
if (particleLayer && !prefersReducedMotion) {
  const particleCount = window.matchMedia("(max-width: 640px)").matches ? 10 : 24;
...
if (hero && heroDumbbell && systemStage && window.matchMedia("(pointer: fine)").matches && !prefersReducedMotion) {
